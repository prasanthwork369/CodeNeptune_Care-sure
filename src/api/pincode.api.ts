...
export const pincodeApi = {
  check: async (pincode: string): Promise<PincodeCheckResponse> => {
    try {
      ...
      if (__DEV__) console.log('[pincodeApi] check response:', JSON.stringify(res.data));
      ...
      if (__DEV__) console.log('[pincodeApi] check error payload:', JSON.stringify(errPayload));
