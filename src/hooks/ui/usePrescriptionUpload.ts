...
export function usePrescriptionUpload(
    ...
    const handlePicked = (validated: PrescriptionItem[], hadTooLarge: boolean) => {
    ...
    return { pickDocument, pickImage, takePhoto, pickPdf, proceedAfterTooLarge, discardPendingTooLarge, isProceeding };
}
