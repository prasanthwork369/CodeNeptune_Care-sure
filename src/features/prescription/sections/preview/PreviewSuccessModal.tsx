...
import { PreviewSuccessModalProps } from "@/src/features/prescription/types";
        ...
        <Pressable onPress={(e) => e.stopPropagation()} className="w-full">
          <View className="bg-white rounded-[20px] px-6 pt-6 pb-6 w-full items-center relative">
            ...
            <View className="w-28 h-28 rounded-full bg-[#F6FFF1] items-center justify-center mb-4">
              <Image
                source={HOME_IMAGES.presSuccess}
            ...
            <Text
              className="font-inter-bold text-[#222222] mb-1.5 text-center"
              style={{ fontSize: moderateScale(18) }}
            >
              Upload Successful!
            </Text>
            <Text
              className="font-inter-medium text-[#6A6A6A] text-center leading-5 mb-6"
