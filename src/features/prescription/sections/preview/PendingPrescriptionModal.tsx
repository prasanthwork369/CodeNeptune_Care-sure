...
export const PendingPrescriptionModal: React.FC<
  PendingPrescriptionModalProps
> = ({ visible, onViewPrescriptions, onClose }) => (
  <Modal
    visible={visible}
    transparent
    animationType="fade"
    ...
    >
      <Pressable onPress={(e) => e.stopPropagation()}>
        <View className="bg-white rounded-2xl px-6 py-6 w-full">
          ...
          <Text
            className="font-inter-medium text-[#6A6A6A] mb-6 leading-5"
            style={{ fontSize: moderateScale(13) }}
          >
            You already have a prescription under review. Please wait for
            approval or use your existing prescription.
          </Text>
