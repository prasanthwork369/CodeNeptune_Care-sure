...
import { CartBillSummaryProps } from "@/src/features/cart/types";
  ...
  return (
    ...
    >
      ...
      <View className="flex-1 ml-3">
        <Text style={s.billTitle} className="font-inter-bold text-brand-text">
          Total Bill
        </Text>
        <Text
          style={s.billSub}
      ...
      {mrpTotal > toPay && (
        <Text
          style={s.billMrp}
          className="font-inter-bold text-brand-subtext line-through mr-2"
        >
      ...
      <Text
        style={s.billTotal}
        className="font-inter-bold text-brand-text mr-2"
      >
