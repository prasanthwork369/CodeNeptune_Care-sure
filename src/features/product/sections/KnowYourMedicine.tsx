    ...
    >
      ...
      <View className="bg-white rounded-[12px] px-5 py-6 mb-7 border border-[#E5E7EB]">
        <View className="flex-row items-center mb-6">
          <View
            className="bg-[#F1F7FF] rounded-[6px] items-center justify-center mr-4"
            style={{ width: exactScale(48), height: exactScale(48) }}
          >
            <Image
          ...
          <View className="flex-1">
            ...
            <Text
              style={[{ fontSize: moderateScale(14) }, { color: "#009989" }]}
        ...
        <View className="flex-row items-center mb-6">
          <View
            className="bg-[#F4F1FF] rounded-[6px] items-center justify-center mr-4"
            style={{ width: exactScale(48), height: exactScale(48) }}
          >
            <Image
