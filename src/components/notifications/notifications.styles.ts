...
export const styles = StyleSheet.create({
    ...
    rxTitle:     { fontSize: moderateScale(14, 0.3), fontWeight: '600', color: '#1A1C1E', marginBottom: 2 },
    rxSub:       { fontSize: moderateScale(12, 0.3), fontWeight: '400', color: '#6A6A6A' },
    rxChip:      { fontSize: moderateScale(11, 0.25), fontWeight: '600' },
    ...
    notifTitle:  { fontSize: moderateScale(14, 0.3), lineHeight: moderateScale(20, 0.3), fontWeight: '600', color: '#222222', letterSpacing: 0 },
    notifBody:   { fontSize: moderateScale(12, 0.3), lineHeight: moderateScale(12, 0.3), fontWeight: '400', color: '#6A6A6A', letterSpacing: 0 },
    notifTime:   { fontSize: moderateScale(10, 0.25), lineHeight: moderateScale(10, 0.25), fontWeight: '500', color: '#ADABAB', letterSpacing: 0 },
