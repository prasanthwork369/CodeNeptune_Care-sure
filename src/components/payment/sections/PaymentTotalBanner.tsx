...
export const PaymentTotalBanner: React.FC<PaymentTotalBannerProps> = ({ toPay }) => {
    return (
        ...
        >
            ...
            <View style={{ flexDirection: 'row', alignItems: 'baseline', marginTop: exactScale(8) }}>
                <Text style={{ fontSize: moderateScale(24), fontWeight: '700', color: '#fff', marginRight: exactScale(4) }}>₹</Text>
                <Text style={{ fontSize: moderateScale(42), fontWeight: '800', color: '#fff' }}>{toPay}</Text>
            </View>
            <View style={{ marginTop: exactScale(16), paddingTop: exactScale(16), borderTopWidth: 1, borderTopColor: 'rgba(255,255,255,0.15)', flexDirection: 'row', alignItems: 'center' }}>
                <VerifiedUserWhiteIcon width={16} height={16} />
                <Text style={{ fontSize: moderateScale(12), fontWeight: '600', color: '#fff', marginLeft: exactScale(8) }}>
