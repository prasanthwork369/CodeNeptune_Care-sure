...
export const FileTooLargeModal: React.FC<FileTooLargeModalProps> = ({ visible, selectedSizeLabel, maxSizeLabel, onClose, onChooseAnother }) => {
                            ...
                            <View className="w-full bg-white border border-[#919EAB33] rounded-[12px] px-4">
                                <View className="flex-row items-center justify-between py-3 border-b border-[#F0F0F0]">
                                    <View className="flex-row items-center">
                                        ...
                                        <Text className="font-inter-medium text-[#0F1724]" style={{ fontSize: moderateScale(13) }}>
                                            Selected file size
                                        </Text>
                                    </View>
                                    <Text className="font-inter-bold text-[#E0383D]" style={{ fontSize: moderateScale(13) }}>
                                        {selectedSizeLabel}
                                    </Text>
                                </View>
                                <View className="flex-row items-center justify-between py-3">
                                    ...
                                    <Text className="font-inter-bold text-brand-primary" style={{ fontSize: moderateScale(13) }}>
                                        {maxSizeLabel}
                                    </Text>
                                </View>
                            </View>
