...
export const styles = StyleSheet.create({
    ...
    prefix: { fontSize: moderateScale(17, 0.3), fontWeight: '500', color: '#111827' },
    input: { height: '100%', paddingVertical: 0, fontSize: moderateScale(17, 0.3) },
    error: { fontSize: moderateScale(13, 0.3), fontWeight: '500', color: '#EF4444', marginTop: 6, marginBottom: 4, paddingHorizontal: 4 },
