...
export const SaltCompositionBanner: React.FC<SaltCompositionBannerProps> = ({ composition }) => {
    ...
    return (
        ...
        >
            ...
            />
            <View className="flex-row items-center relative z-10 w-full" style={{ minHeight: 56, paddingVertical: 8 }}>
                ...
                <View style={{ flex: 1, marginRight: isTruncatable ? 8 : 0 }}>
                    ...
                    <Text
                        ...
                        onTextLayout={(e) => setIsTruncatable(e.nativeEvent.lines.length > 1)}
                    >
                        {composition}
                    </Text>
                    <Text
