...
export const ProfileSkeleton = () => {
    ...
    return (
        <ScrollView showsVerticalScrollIndicator={false} className="flex-1 bg-[#F5F6FB]">
            {/* Header Skeleton */}
            <LinearGradient
            ...
            >
                <Skeleton width={88} height={88} borderRadius={44} style={{ borderWidth: 2, borderColor: 'white' }} />
            ...
            <View className="flex-row mx-4 gap-[10px]" style={{ marginTop: -44 }}>
                {[1, 2, 3].map((i) => (
                    <View key={i} className="flex-1 bg-white rounded-xl py-[14px] items-center border border-[#919EAB33]">
            ...
            <View className="mx-4 my-6">
                ...
                <View className="bg-white rounded-xl border border-[#919EAB33] overflow-hidden">
                    {[1, 2, 3, 4, 5, 6].map((i) => (
                        <View key={i} className="flex-row items-center px-4 py-[18px] border-b border-[#EEEFF1]">
