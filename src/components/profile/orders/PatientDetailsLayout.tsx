  ...
  return (
    ...
    >
      <View
        ...
        style={{ width: 46, height: 46, backgroundColor: "#E8F5EE" }}
      >
      ...
      <View className="flex-1">
        ...
        <View className="flex-row items-center gap-x-2">
          ...
          <View
            className="px-2 py-0.5 rounded-full border border-[#919EAB33]"
      ...
      >
        ...
        <Text
          className="font-inter-semibold text-[#6A6A6A] ml-1"
