...
export const ReturnSuccessModal: React.FC<ReturnSuccessModalProps> = ({ isVisible, onClose, onGoHome }) => {
    return (
        <Modal
            visible={isVisible}
            transparent
        ...
        >
            <View className="flex-1 bg-black/70 items-center justify-center px-8">
                <View
                    ...
                    style={{ borderRadius: 20, paddingHorizontal: 32, paddingVertical: 36 }}
                >
                    {/* Success tick image */}
                    <Image
                    ...
                    >
                        <Text style={s.labelXl} className="font-inter-semibold text-[#1A1C1E]">
                            Go Home
                        </Text>
                    </Touchable>
                </View>
