...
export function ReturnSuccessLayout() {
  ...
  return (
    <SafeAreaView edges={['top', 'bottom']} style={{ flex: 1, backgroundColor: '#F8F9FB' }}>
      <ScrollView
        contentContainerStyle={{ padding: exactScale(16), paddingBottom: verticalScale(100) }}
        showsVerticalScrollIndicator={false}
      >
        {/* Top Header Section */}
        <View style={{ alignItems: 'center', marginTop: verticalScale(32), marginBottom: verticalScale(24) }}>
          <View
            style={{
              width: exactScale(64),
          ...
          >
            <icons.return_check width={exactScale(32)} height={exactScale(32)} color={colors.primary} />
          </View>
        ...
        >
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            ...
            >
              <icons.return_wallet width={exactScale(20)} height={exactScale(20)} color={colors.primary} />
            </View>
            <View>
              <Text style={{ fontSize: typography.caption.fontSize, color: colors.subtext, marginBottom: verticalScale(2) }}>
                Refund Method
              </Text>
          ...
          <View style={{ height: 1, backgroundColor: '#F1F5F9', marginVertical: verticalScale(16) }} />
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            ...
            >
              <icons.return_calendar_today width={exactScale(20)} height={exactScale(20)} color={colors.primary} />
            </View>
            <View>
              <Text style={{ fontSize: typography.caption.fontSize, color: colors.subtext, marginBottom: verticalScale(2) }}>
                Submitted On
        ...
        >
          ...
          <View style={{ paddingLeft: exactScale(8) }}>
            ...
            <View style={styles.timelineItem}>
              <View style={styles.timelineIconContainer}>
                <View style={[styles.circleFilled, { backgroundColor: colors.primary }]}>
                  <icons.return_check width={exactScale(14)} height={exactScale(11)} color={colors.white} />
                </View>
            ...
            <View style={styles.timelineItem}>
              <View style={styles.timelineIconContainer}>
                <View style={[styles.circleOutline, { borderColor: colors.primary }]}>
                  <icons.return_review width={exactScale(18)} height={exactScale(18)} color={colors.primary} />
                </View>
            ...
            <View style={styles.timelineItem}>
              <View style={styles.timelineIconContainer}>
                <View style={[styles.circleOutline, { borderColor: '#E2E8F0' }]}>
                  <icons.return_calendar width={exactScale(16)} height={exactScale(16)} color={colors.subtext} />
                </View>
                <View style={styles.timelineLineDotted}>
                  <View style={styles.dot} />
                  <View style={styles.dot} />
            ...
            <View style={styles.timelineItem}>
              <View style={styles.timelineIconContainer}>
                <View style={[styles.circleOutline, { borderColor: '#E2E8F0' }]}>
                  <icons.return_pickup width={exactScale(18)} height={exactScale(18)} color={colors.subtext} />
                </View>
                <View style={styles.timelineLineDotted}>
                  <View style={styles.dot} />
                  <View style={styles.dot} />
            ...
            <View style={[styles.timelineItem, { marginBottom: 0 }]}>
              <View style={styles.timelineIconContainer}>
                <View style={[styles.circleOutline, { borderColor: '#E2E8F0' }]}>
                  <icons.return_rupee width={exactScale(16)} height={exactScale(16)} color={colors.subtext} />
                </View>
              </View>
              <View style={styles.timelineContent}>
