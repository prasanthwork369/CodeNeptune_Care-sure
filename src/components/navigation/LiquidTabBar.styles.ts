...
export const styles = StyleSheet.create({
    uploadText: { fontSize: moderateScale(13, 0.25), color: 'white', fontFamily: 'Inter-Bold', textAlign: 'center', lineHeight: moderateScale(16, 0.25) },
    tabLabel:   { fontSize: moderateScale(11, 0.2), marginTop: 2, textAlign: 'center', width: '100%' },
