    ...
    return (
        ...
        >
            <View className="px-4 mb-6">
                <Text style={s.sectionTitle} className="font-inter-bold text-brand-text mb-4 ml-1">
                    Medicine Comparison
                </Text>
                ...
                <View className="bg-white rounded-[16px] p-5 shadow-sm border border-[#919EAB33]">
                    ...
                    <View className="border-b border-dashed border-[#919EAB33] pb-4 mb-4">
                        <Text style={s.label} className="font-inter-semibold text-brand-subtext uppercase tracking-[1px] mb-2">
                            MEDICINE
                        </Text>
                        <View className="flex-row items-center justify-between">
                            <Text style={s.value} className="font-inter-semibold text-brand-text">
                                Paracetamol 650mg
                            </Text>
