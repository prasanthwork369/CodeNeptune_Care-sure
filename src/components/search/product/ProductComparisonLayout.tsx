...
export const ProductComparisonLayout: React.FC<ProductComparisonLayoutProps> = ({ id }) => {
    const router = useNav();
            ...
            <Animated.View style={[{ backgroundColor: '#F9FAFB' }, containerStyle]}>
                <Animated.View style={contentStyle}>
                    <View style={{ flex: 1, backgroundColor: '#F9FAFB' }}>
                        ...
                        <ProductHeader query={raw?.name ?? ''} cartCount={cartCount} isSearching={true} onBack={handleBack} />
