...
export const HOME_IMAGES = {
  ...
  corporateBenefits: require("../../assets/images/wallet/corporate-benefits.png"),
  giftBoxGreen: require("../../assets/images/wallet/gift-box-green.png"),
  taxBuilding: require("../../assets/images/wallet/tax-building.png"),
